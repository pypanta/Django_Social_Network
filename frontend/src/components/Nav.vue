<template>
  <header>
    <div class="header-wrapper">
      <div class="brand">
        <h1>Django Social</h1>
        <p>Social network web site created with Django</p>
      </div>
      <ul class="navbar">
        <li class="nav-item">
          <router-link :to="{ name: 'home' }" title="Home" class="nav-link">
        ...
        <li class="nav-item">
          <router-link :to="{ name: 'chat' }" title="Chat" class="nav-link">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="nav-icon">
        ...
        <li class="nav-item">
          <router-link :to="{ name: 'search' }" title="Search" class="nav-link">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="nav-icon">
      ...
      <div class="profile">
        ...
        <ul
          v-if="store.isAuthenticated && store.userData.id"
          class="profile-menu"
        >
          <li>
            <router-link
